      ...
      <div className="header-section">
        <div className="container">
          <div className="hero-content-wrapper">
            ...
            <a data-w-id="21b1975f-9fa3-4d15-c618-031aac97b536" href="https://discord.gg/836qKwvTJG" target="_blank" rel="noreferrer"  className="button w-button interaction2" data-cy="join-discord-link">join our discord</a>
          </div>
        </div>
