          ...
          <div className="container">
            ...
            <div className="overview-wrapper">
              <div data-w-id="24d2a5ba-8de8-ad42-53e1-655f69d782e0" className="w-layout-grid team-grid interaction3">
                <div className="overview-image-wrapper"><img src="/images/Team-Sory-Image.png" loading="lazy" alt="" className="image-cover"/><img src="/images/Logo_20.png" loading="lazy" height="72" alt="" className="image-accent"/></div>
                <div>
